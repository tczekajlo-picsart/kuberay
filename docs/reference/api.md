...
| `gateway` _string_ | Gateway is the name of the Gateway object for the RayService to serve traffics during an IncrementalUpgrade. |  |  |
| `httpRoute` _string_ | HTTPRoute is the name of the HTTPRoute object for the RayService to split traffics during an IncrementalUpgrade. |  |  |
